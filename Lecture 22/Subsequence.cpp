...
void F(int i, int j) {
	...
	if (input[i] == '\0') {
		//I have found a output
		//SInce it is a character array just put a null
		//character in the output array at the current
	...
	//You don't need to add anything in output array.
	F(i + 1, j);
